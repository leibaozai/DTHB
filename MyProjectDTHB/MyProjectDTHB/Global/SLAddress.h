...
#define kFLClickCellUrl @"http://www.duitang.com/napi/blog/list/by_category/?app_code=arwen&platform_version=8.1&app_version=1.8&cate_key=%@&limit=24&locale=zh-Hans_HK&__dtac=498277&platform_name=iPhone&start=%d&device_name=iPhone5"
